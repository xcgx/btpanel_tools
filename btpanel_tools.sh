#!/bin/bash
#全局变量
download_url=https://proxy.xcgx.eu/https://raw.githubusercontent.com/xcgx/btpanel_tools/main
...
degrade_btpanel(){
    ...
    wget -T 5 -O panel.zip https://proxy.xcgx.eu/https://raw.githubusercontent.com/xcgx/btpanel_tools/main/update/LinuxPanel-${version}.zip
